    ...
    <>
      <div className="font-Inter">
        ...
        <div className="container headquarters">
          ...
          <div className="row animation">
            <div className="d-flex animation-txt ">
              <p className="big-txt">7.7B</p>
              <p>
                <span>Annotations</span> To Date
              </p>
              <p className="big-txt">1B+</p>
              <p>
        ...
        <div className="container my-btn">
          <button type="button" className="btn my-custom">
            Scale is growing. Grow with us <BsArrowRight />
          </button>
        </div>
            ...
            <div className=".row">
              ...
              <div className="container my-btn">
                <button className="btn my-custom">
                  Meet Our Customers <BsArrowRight />
                </button>
              </div>
            </div>
          </div>
            ...
            <div className="row">
              <div className="col-lg-4">
                <div className="one-scalenew">
                  ...
                  <h5>
                    Scale AI’s Rapid Growth Reflects Widening Demand for Smart
                    Software
                  </h5>
                </div>
              </div>
              <div className="col-lg-4">
                <div className="one-scalenew">
                  ...
                  <p>Fortune</p>
                  <h5>
                    Data-labeling company Scale AI valued at $7.3 billion with
                    new funding
                  </h5>
                </div>
              </div>
              <div className="col-lg-4">
                <div className="one-scalenew">
                  ...
                  <h5>
                    A funding frenzy helped catapult 34 new companies onto the
                    list and boost their combined
                  </h5>
                </div>
              </div>
            </div>
        ...
        <div className="container careers">
          <div className="row">
            <div className="col-lg-12">
              <h1>Careers</h1>
              <p>
                Join us as we continue to accelerate the development of AI
                applications.
              </p>
              <h5>
                Learn More About Careers at Scale{" "}
            ...
            <div className="row">
              <div className="col-lg-12">
                ...
                <div className="my-btn">
                  ...
                  <button className="btn my-custom-default">
                    Talk To Sales
                  </button>
                </div>
              </div>
